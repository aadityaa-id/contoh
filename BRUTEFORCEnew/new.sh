...
echo $i" |"$cy"            TERMUX HACKING TOOLS"$i"             |"
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" Mr.GameOver  [aaditya]"$i"             |"
echo $i" |"$pu" FACEBOOK :"$ku" Aadityaa"$i"                         |"
echo $i" |"$pu" Contack WhatsApp :"$ku" 081299140544"$i"             |"
echo $i" |"$pu" Contack Gmail :"$ku" adityarmd16@gmail.com"$i"       |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
...
echo $i"|"$me" 4"$i" |"$cy" BRUTEFORCE FB MBF        "$i"|"$i"    |"$cy" E"$i" |"
echo $i"|"$me" 5"$i" |"$cy" FACEBRUTE N1ght420       "$i"|"$i"    |"$cy" T"$i" |"
...
echo $i"|"$me"16"$i" |"$cy" PHISING FACEBOOK 3       "$i"|"$i"    |"$cy" T"$i" |"
echo $i"|"$me"17"$i" |"$cy" PHISING FACEBOOK 4       "$i"|"$i"    |"$cy" O"$i" |"
echo $i"────────────────────────────────"$i"    |"$cy" O"$i" |"
echo $i"|"$me"18"$i" |"$cy" INSTALL BAHAN DULU COEG  "$i"|"$i"    |"$cy" L"$i" |"
echo $i"|"$me"19"$i" |"$cy" KELUAR/EXIT PROGRAM      "$i"|"$i"    |"$cy" S"$i" |"
echo $i"────────────────────────────────    ─────"
echo
echo $me"┌==="$bi"["$i"aadityaa"$bi"]"$me"======"$bi"["$i""Pilih Nomornya""$bi"]"
echo $me"¦"
read -p"└──# " pil
...
sleep 2
echo $i"sampai jumpa by Hacker Mr.GameOver"
sleep 2
echo $ku"WhatsApp :"$i" 081299140544"
echo $ku"Facebook :"$i" Aadityaa"
sleep 2
